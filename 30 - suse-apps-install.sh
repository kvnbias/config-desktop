...
#   case $ibt in
#     [Yy]* )
#       sudo zypper -n install --no-recommends bluez blueman pulseaudio-module-bluetooth
# 
#       echo "
...
#     [Yy]* )
#       user=$(whoami)
#       sudo zypper -n install --no-recommends samba
# 
...
#   case $ic in
#     [Yy]* )
#       sudo zypper -n install --no-recommends cups bluez-cups cups-pdf nss-mdns
# 
...
# #       sudo zypper -n install --no-recommends hfsplusutils hfsutils hfsplus-tools
# #       break;;
# #     * ) break;;
# #   esac
# # done
...
#     [Yy]* )
#       cd /tmp
#       sudo zypper -n install --no-recommends fuse zlib bzip2 libattr
#       sudo zypper -n install --no-recommends fuse-devel zlib-devel bzip2-devel libattr-devel
...
# 
#       sudo zypper remove -y fuse-devel bzip2-devel libattr-devel cmake
#       cd /tmp
#       break;;
#     * ) break;;
#   esac
...
#       sudo zypper -n install --no-recommends skypeforlinux-64.rpm
#       break;;
#     * ) break;;
#   esac
# done
